...
#     (+env_registry.Embodied=...), so nothing inside the gitignored vendor/
...
EXPERIMENT_NAME="grpo_embodied_qwen3vl4b"

REPO=$(cd "$(dirname "$0")/../../.." && pwd)
VAGEN=${REPO}/vendor/vagen
EXPERIMENT_DIR=${EXPERIMENT_DIR:-~/exps/${PROJECT_NAME}/${EXPERIMENT_NAME}}
DATASET_TRAIN=${DATASET_TRAIN:-${REPO}/embodiedbench/training/vagen/train_embodied.yaml}
DATASET_VAL=${DATASET_VAL:-${REPO}/embodiedbench/training/vagen/val_embodied.yaml}
