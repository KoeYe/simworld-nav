"""Trainer-neutral training samples and their invariants (PLAN.md 11).

A ``TrainingSample`` is what any framework adapter consumes. Its invariants are
the R1 selection gate written down as code, because PLAN.md 2.1 names
...
def check_reward_conservation(
    ...
    """PLAN.md 11.1: fan-out must preserve total reward exactly once.
