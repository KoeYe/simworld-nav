...
This exists to satisfy the parts of PLAN.md 11.1's selection gate that are easy
...
class Qwen3VLAdapter:
    ...
    def logits_for_prompt(self, prompt: str) -> Any:
        """Logits for a fixed prompt, for the weight-sync check (PLAN.md M8)."""
    ...
    def parameter_digest(self) -> str:
        ...
        PLAN.md M8 requires weight synchronization to produce a *changed*
