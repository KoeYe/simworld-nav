"""The episode loop and trajectory writer (PLAN.md 10).

PLAN.md M6 will require this harness to run text and cached backends "without
...
is how PLAN.md 7's termination/truncation split stays honest even for budgets
        ...
        for step_index in range(instance.budgets.steps):
            ...
            turns.append(
                TrajectoryTurn(
                    ...
                    # rather than fabricated. PLAN.md M6's mask assertions run
