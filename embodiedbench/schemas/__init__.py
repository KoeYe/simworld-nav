"""Versioned protocol schemas (PLAN.md M1).

Every contract PLAN.md names lives here: WorldBundle, OverlaySpec,
...
(PLAN.md M1); consumers pin exact revisions. ``SCHEMA_REGISTRY`` maps every
