...
degenerate_segments          zero-length edges (PLAN.md 3.3.1, Paris 186/187)
...
def _unknown_asset_names() -> tuple[list[dict], list[dict]]:
    ...
    warning -- the same silent drop PLAN.md 3.3.11 records for
...
STRESS_CASES: list[StressCase] = [
    ...
    StressCase("degenerate_segments", "zero-length edges (PLAN.md 3.3.1)", _degenerate_segments,
