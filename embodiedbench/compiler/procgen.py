...
This is the first compiler producer (PLAN.md 6). It reads the navigation graph
...
subtly disagrees with the environment — exactly the failure PLAN.md 17 lists as
...
the NavMesh evidence PLAN.md M2 requires is not available for procgen maps and
...
# The engine's node kinds, mapped onto the schema's vocabulary. PLAN.md 3.2
...
def extract_nav_graph(city_map: Any) -> NavGraph:
    ...
    for node, neighbours in adjacency.items():
        ...
        for neighbour in neighbours or []:
            ...
            if length <= 0.0:
                # PLAN.md 3.3.1 filters zero/near-zero segments before
    ...
    *,
    ...
    return WorldBundle(
        ...
        notes=[
            ...
            "(PLAN.md M2 applies to UE-sourced maps).",
        ],
    )
...
def environment_for(
    ...
    *,
    ...
    certificate = Certificate(
        ...
        limitations=[
            "no NavMesh validation (procgen map, PLAN.md M2 not applicable)",
