...
PLAN.md M0 requires episodes to replay to identical transition, terminal-state,
...
is never modified: PLAN.md M0 requires that existing repositories are left
...
TIE_BREAK_REASON = (
    ...
    "determinism (PLAN.md M0) and cross-process EpisodeSpec equality (PLAN.md "
