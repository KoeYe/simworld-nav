...
PLAN.md M0 acceptance: "One existing procgen text episode and one visual episode
...
PLAN.md 7.2 does not require pixel equality between *runtimes*. Within one
...
# energy, order lifecycle, and clock -- the surface PLAN.md 7.2 names.
#
...
STATE_POLICY = ExtractionPolicy(
    documented_exclusions={
        ...
        "run_dir": (
            ...
            "machine-specific path, which PLAN.md 5.1 bars from portable artifacts, "
