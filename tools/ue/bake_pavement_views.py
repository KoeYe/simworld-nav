...
PROJECT = Path("/data/murray/CityCore_Paris")
ENGINE = Path("/data/koe/UnrealEngine-5.8.0-release")
DEFAULT_OUT = Path("/data/murray/paris_streets_pavement") / MAP_NAME
